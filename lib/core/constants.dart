...
class Constants {
  ...
  static const double angularDrag = 500.0;    // Сопротивление вращению
  static const double rudderEffect = 2.0;     // Насколько эффективно руль поворачивает лодку
  ...
  // Параметры ветра
  static const double windSpeed = 10.0; // Скорость ветра (м/с), примерно 20 узлов
...
// Параметры течения (Current)
  static const double currentSpeed = 0.5; // Скорость течения (м/с, около 1 узла)
